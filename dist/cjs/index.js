...
const SidePanel = ({ data, className }) => {
    return (jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: jsxRuntimeExports.jsx("section", { children: jsxRuntimeExports.jsxs("div", { className: className, children: [...data.map((x) => jsxRuntimeExports.jsx("div", { children: x.icon }))] }) }) }));
};
